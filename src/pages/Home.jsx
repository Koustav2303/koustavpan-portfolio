  ...
  const reviews = [
    {
      ...
      text: "Koustav didn't just write code; he architected a solution. The transition from our old legacy system to the new React stack was seamless.",
      stars: 5,
    },
    {
      id: 2,
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 relative">
      ...
      <div className="relative h-[400px] flex items-center justify-center perspective-1000">
        <AnimatePresence initial={false} custom={direction}>
          ...
          >
            ...
            <div className="flex gap-1 mb-6 text-yellow-400">
              {[...Array(reviews[index].stars)].map((_, i) => <FaStar key={i} />)}
            </div>
            <p className="text-gray-300 text-lg md:text-xl leading-relaxed italic mb-6">"{reviews[index].text}"</p>
            <div>
        ...
        <button onClick={prevStep} className="absolute left-0 md:-left-12 z-10 p-4 bg-white/5 rounded-full hover:bg-cyan-500/20 hover:text-cyan-400 transition-all border border-white/5 backdrop-blur-md group">
          <FaChevronLeft className="group-hover:-translate-x-1 transition-transform" />
        </button>
        <button onClick={nextStep} className="absolute right-0 md:-right-12 z-10 p-4 bg-white/5 rounded-full hover:bg-cyan-500/20 hover:text-cyan-400 transition-all border border-white/5 backdrop-blur-md group">
